...
Authors: Dave Fisher and Hyang Seo.
...
#     Hint: This program can be done in as littpyle as 2 lines of code (1 import, 1 function call)
...
def main():
    ...
    print("  Drive demo")
    print("--------------------------------------------")
    ev3.Sound.speak("say something I'm giving up on you").wait()
